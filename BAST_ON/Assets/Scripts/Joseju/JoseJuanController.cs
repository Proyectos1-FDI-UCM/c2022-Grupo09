...
public class JoseJuanController : MonoBehaviour
{
    ...
    /// <summary>
    /// Velocidad a la que Joseju se dirige a su posici�n de la fase 1
    /// </summary>
    ...
    /// <summary>
    /// Valor que indica si Joseju tiene que ir a su posici�n en la primera fase
    /// </summary>
    ...
    /// <summary>
    /// Referencia al objeto con la posici�n de Joseju en la fase 0
    /// </summary>
    [SerializeField] private GameObject _phaseZeroPositionObject;
    /// <summary>
    /// Referencia al objeto con la posici�n de Joseju en la fase 1
    /// </summary>
    [SerializeField] private GameObject _firstPhasePositionObject;
    /// <summary>
    /// Referencai a la posici�n de Joseju en la fase 1
    /// </summary>
    ...
    /// <summary>
    /// M�todo que coloca la c�mara en la posici�n que tendr� en la primera fase
    /// </summary>
